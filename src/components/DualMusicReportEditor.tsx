...
// 套用參數到 MusicXML
function applyParamsToMusicXML(musicXML: string, params: DualMusicReportParams): string {
...
const DualMusicReportEditor: React.FC<DualMusicReportEditorProps> = ({
    musicXML,
    initialParams,
    onParamsChange,
}) => {
    ...
    const renderInstrumentSelect = (field: keyof DualMusicReportParams, label: string) => (
    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-6 p-4 bg-base-200 rounded-lg">
                ...
                {isEditing ? (
                    ...
                    <div className="space-y-4">
                        ...
                        {/* 第一演奏者樂器 */}
                        <div>
                            <h4 className="text-sm font-medium text-primary mb-2">第一演奏者</h4>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        {/* 第二演奏者樂器 */}
                        <div>
                            <h4 className="text-sm font-medium text-secondary mb-2">第二演奏者</h4>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* 樂譜顯示 */}
            <MusicEmbed musicXML={processedXML} height="600px" />
...
export default DualMusicReportEditor;
